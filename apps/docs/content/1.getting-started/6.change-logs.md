...
## Version 1.3.1 (Latest) - March 18, 2026
...
| -------------------------- | --------------- | ---------------------------------------------------- |
| `@hydra-sdk/core`          | 1.3.0           | Core library for building decentralized applications |
| `@hydra-sdk/transaction`   | 1.1.7           | Transaction building and management utilities        |
