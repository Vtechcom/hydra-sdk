...
## Version 1.1.7 (Latest) - January 30, 2026
...
| -------------------------- | --------------- | ---------------------------------------------------- |
| `@hydra-sdk/core`          | 1.1.7           | Core library for building decentralized applications |
| `@hydra-sdk/transaction`   | 1.1.7           | Transaction building and management utilities        |
| `@hydra-sdk/bridge`        | 1.1.7           | Bridge functionality for wallet connections          |
