...
**Latest Version: v1.4.0** - Adds the RedeemerUtils namespace, new DatumUtils encoders, ValidationUtils, and Cardano protocol v11 support.
...
- **RedeemerUtils Namespace**: New helpers to build redeemers (`mkRedeemer`, `mkSpendRedeemer`, `mkMintRedeemer`, `mkUnitRedeemer`, `mkExUnits`)
- **New DatumUtils Encoders**: `mkBool`, `mkOption`, `mkBytesList`, `mkIntList`, `mkOutputRef`, `mkAddress`, and `parseAddress`
- **ValidationUtils**: `isValidTxOutput` moved into a dedicated validation namespace
- **Protocol v11 Support**: Updated default protocol parameters (e.g. `minPoolCost = 170000000`)
