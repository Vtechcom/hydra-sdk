...
- `networkId` (optional): `NETWORK_ID.MAINNET` (1) or `NETWORK_ID.TESTNET` (0), default is MAINNET
...
- Learn about [Building Transactions](/guides/building-transactions)
- Explore [Working with Utilities](/guides/working-with-utilities)
