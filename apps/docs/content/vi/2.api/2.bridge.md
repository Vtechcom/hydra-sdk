...
Lớp chính để kết nối và quản lý Hydra Heads.
...
- `options` (HydraBridgeOptions):
  - `url?`: WebSocket URL (vd: 'ws://localhost:4001')
...
4. **Authentication**: Sử dụng JWT tokens thích hợp cho kết nối Hexcore
