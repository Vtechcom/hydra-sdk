...
Tạo provider Blockfrost để truy vấn dữ liệu blockchain.
...
Tạo provider Ogmios để kết nối WebSocket tới Cardano node.

**Parameters:**

- `options` (OgmiosOptions):
  - `url` (string): WebSocket URL (vd: 'ws://localhost:1337')
