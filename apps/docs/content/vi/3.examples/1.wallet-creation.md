---
title: Ví dụ Tạo Ví
description: Học cách tạo ví sử dụng Hydra SDK
---

# Các Ví Dụ Tạo Ví

Học cách tạo và quản lý ví sử dụng các pattern thực tế từ Hydra SDK.
...
// Khôi phục ví từ mnemonic hiện có
const restoreWallet = () => {
...
- **Tạo Mnemonic**: `AppWallet.brew(128)` cho 12/24 từ
- **Nhiều Loại Khóa**: mnemonic, root key, CLI keys
- **HD Derivation**: `getAccount(accountIndex, keyIndex)`
- **Các Loại Địa Chỉ**: base, enterprise, reward addresses
- **Hỗ Trợ Network**: Mainnet/Testnet/Preprod/Preview
- **Ưu Tiên TypeScript**: Full type safety

Xem [API Reference](/api) để biết đầy đủ wallet methods.
