...
## Version 1.4.0 (Latest) - July 2026
...
| -------------------------- | --------------- | ---------------------------------------------------- |
| `@hydra-sdk/core`          | 1.4.0           | Core library for building decentralized applications |
| `@hydra-sdk/transaction`   | 1.1.8           | Transaction building and management utilities        |
| `@hydra-sdk/bridge`        | 1.3.1           | Bridge functionality for wallet connections          |
| `@hydra-sdk/cardano-wasm`  | 0.0.7           | Cardano WASM bindings and utilities                  |
