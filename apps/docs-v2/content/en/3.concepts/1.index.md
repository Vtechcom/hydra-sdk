...
2. **[Follow Integration Guide](/guides/hydra-integration)** - Step-by-step integration
3. **[Explore Commit/Decommit](/concepts/commit-to-hydra)** - Manage UTxOs in heads
4. **[Build Transactions](/concepts/transactions-in-hydra)** - Create Hydra transactions
...
> **Next**: Learn how to [Commit UTxOs to Hydra](/concepts/commit-to-hydra) to start using Hydra Heads
